  ...
  useEffect(() => {
    ...
    const fetchDashboardData = async () => {
      try {
        ...
        // If it's a 400 error about school code, suggest logout
        if (err.response?.status === 400 && errorMessage.includes("school code")) {
          setError(errorMessage + " - Please log out and log back in to refresh your session.");
        }
      } finally {
        setLoading(false);
      }
        ...
        <div style={{ maxWidth: "1400px" }}>
          ...
          {(stats.alerts.maintenanceNeeded > 0 || stats.alerts.faultyDevices > 0) && (
            <div style={{
              ...
              <div>
                <h3 style={{ margin: 0, color: "#92400e", fontSize: "1.1rem" }}>⚠️ Attention Required</h3>
        ...
        <div style={{ maxWidth: "1400px" }}>
          ...
          {stats.workload.totalTasks > 0 && (
            <div style={{
              ...
              <div>
                <h3 style={{ margin: 0, color: "#92400e", fontSize: "1.1rem" }}>⚠️ Pending Tasks</h3>
                <p style={{ margin: "0.5rem 0 0 0", color: "#92400e" }}>
